...
quest.foodItem = function(player)
    ...
    local foodTable =
    {
        [4]  = dsp.items.CHUNK_OF_HOMEMADE_CHEESE,
        [8]  = dsp.items.HOMEMADE_STEAK,
        [12] = dsp.items.CONE_OF_HOMEMADE_GELATO,
        [16] = dsp.items.LOAF_OF_HOMEMADE_BREAD,
        [40] = dsp.items.HOMEMADE_SALISBURY_STEAK,
        [44] = dsp.items.HOMEMADE_OMELETTE,
        [20] = dsp.items.PLATE_OF_HOMEMADE_RISOTTO,
        [24] = dsp.items.HOMEMADE_RICE_BALL,
        [28] = dsp.items.PITCHER_OF_HOMEMADE_HERBAL_TEA,
        [32] = dsp.items.BOWL_OF_HOMEMADE_STEW,
