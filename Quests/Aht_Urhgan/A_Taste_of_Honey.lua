...
quest.sections = {
        ...
        [dsp.zone.AHT_URHGAN_WHITEGATE] = {
            ['Qutiba'] = {
                ...
                onTrade = function(player, npc, trade)
                    if npcUtil.tradeHasExactly(trade, {{dsp.items.POT_OF_WHITE_HONEY, 3}}) then
    ...
    },
    {
        ...
        [dsp.zone.AHT_URHGAN_WHITEGATE] = {
            ['Qutiba'] = {
                onTrade = function(player, npc, trade)
                    if npcUtil.tradeHasExactly(trade, {dsp.items.POT_OF_WHITE_HONEY}) then
